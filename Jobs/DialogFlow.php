...
abstract class DialogFlow
{
    ...
    public static function detectIntentTexts($projectId, $text, $sessionId, $languageCode = 'pt-BR', $contextName = '')
    {
        ...
        CURLOPT_URL => 'https://dialogflow.googleapis.com/v2/projects/voicebot-judite/agent/sessions/-:detectIntent?key=AIzaSyCYBsO7GhOFMmxei8Bo0YyrGlstiqJfZok',
